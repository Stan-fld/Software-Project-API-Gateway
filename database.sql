...
VALUES ('00646365-48f6-4792-979d-6152a042f2e7', 'DU', 'DELETE', 'deleteUser', 'Delete user', NOW(), NOW(),
       ...
       ('5b5f78f1-df07-4d84-886a-b37d2fc603c3', 'GIS', 'GET', 'getItems', 'Get restaurant items for commercial service',
        NOW(), NOW(), 'f10763f0-ee18-4352-b855-63a3ca330d70',
        '82546b89-be40-435e-a7e2-e833dcb734f6'),
       ('5f08195a-6d6f-4318-836e-7b5d69e80469', 'UI', 'PATCH', 'updateItem', 'Update item', NOW(), NOW(),
       ...
       ('ab5948fa-dac2-481d-bdb7-027a5bbc498c', 'GR', 'GET', 'getRestaurant', 'Get a restaurant for deliverer',
        NOW(), NOW(), 'ef31c95f-1b96-446e-9a8a-387dc92c1094',
        '82546b89-be40-435e-a7e2-e833dcb734f6'),
       ('afb0f591-8499-4174-85f3-1d4127f6dd4f', 'DD', 'DELETE', 'revokeMyDelivererAccount', 'Revoke my deliverer account',
        NOW(), NOW(), 'ef31c95f-1b96-446e-9a8a-387dc92c1094',
        '63f229e2-8342-4e27-b12d-565738628402'),
       ...
       ('be071d06-1e5a-4bf3-a715-19de2cdc109f', 'GRS', 'GET', 'getRestaurants', 'Get restaurants for technical service',
        ...
        '82546b89-be40-435e-a7e2-e833dcb734f6'),
       ('c138d8e5-4e8f-4fa6-ab6e-ae1cad4984b0', 'DI', 'DELETE', 'deleteItem', 'Delete item', NOW(), NOW(),
        '47ed7c0d-b835-4b26-938c-794ff764313c', '82546b89-be40-435e-a7e2-e833dcb734f6'),
       ...
       ('dd63124f-0e8a-49a7-9e42-8198d6317f64', 'CI', 'POST', 'createItem', 'Create item', NOW(), NOW(),
        '47ed7c0d-b835-4b26-938c-794ff764313c', '82546b89-be40-435e-a7e2-e833dcb734f6'),
       ('e29c3228-613d-45d7-8aa8-5a91c4835895', 'GR', 'GET', 'getRestaurant', 'Get a restaurant for client',
        NOW(), NOW(), 'b319fc5a-0b05-4e77-8980-07693a8ba7b6',
        '82546b89-be40-435e-a7e2-e833dcb734f6'),
       ('edce8554-56a7-454e-8fc0-7fe9a27fcc59', 'GO', 'GET', 'getOrder', 'Get order for client', NOW(), NOW(),
